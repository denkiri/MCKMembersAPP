...
@Composable
fun ChangePasswordScreen(navController: NavHostController, viewModel: LoginViewModel = hiltViewModel()){
                ...
                Column(
                    ...
                    Column(
                        ...
                        NormalButton(
                            ...
                            text = stringResource(id = R.string.change_password_label),
                            onClick = {
                                viewModel.onUiEvent(loginUiEvent = LoginUiEvent.Submit)
                                if (loginState.isLoginSuccessful) {
                                    viewModel.changeMemberPassword(viewModel.loginState.value.username.trim(),
